...
<div class="group-manager-content">
	<div class="group-manager-box">
		...
		<div class="group-list-wrap row m-l-0 m-r-0">
		    <div class="group-col col-md-6 col-xs-6 p-0">
		    ...
		    <form action="<?php _e( get_module_url('save') )?>" data-redirect="<?php _e( get_module_url() )?>" method="POST" class="actionForm saveFormGroups group-col col-md-6 col-xs-6 p-0">
